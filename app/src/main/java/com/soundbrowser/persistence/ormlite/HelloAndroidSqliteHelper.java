 ...
 */
public class HelloAndroidSqliteHelper extends OrmLiteBaseActivity<DatabaseHelper> {
	...
	private void doSampleDatabaseStuff(String action, TextView tv) {
		// get our dao
		RuntimeExceptionDao<SimpleData, Integer> simpleDao = null; //getHelper().getSimpleDataDao();
